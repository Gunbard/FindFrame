...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(512, 320)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(512, 320))
        MainWindow.setMaximumSize(QtCore.QSize(512, 320))
        ...
        self.imageInput.setGeometry(QtCore.QRect(250, 190, 121, 91))
        ...
        self.textLog.setGeometry(QtCore.QRect(10, 100, 231, 181))
        ...
        self.btnStartScan.setGeometry(QtCore.QRect(290, 100, 161, 51))
        self.btnStartScan.setObjectName("btnStartScan")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(10, 290, 491, 20))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setTextVisible(False)
        self.progressBar.setInvertedAppearance(False)
        self.progressBar.setObjectName("progressBar")
        self.imageVideoFrame = QtWidgets.QLabel(self.centralwidget)
        self.imageVideoFrame.setGeometry(QtCore.QRect(380, 190, 121, 91))
        ...
        self.testbutton.setGeometry(QtCore.QRect(460, 100, 41, 31))
        self.testbutton.setObjectName("testbutton")
        self.checkBoostContrast = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBoostContrast.setGeometry(QtCore.QRect(310, 70, 141, 18))
        ...
        self.labelFileProgress.setGeometry(QtCore.QRect(250, 160, 251, 21))
